...
import {
    ...
    AlertDialogHeader, AlertDialogOverlay, Button, Input,
    useDisclosure,
    useToast
            ...
            <AlertDialogOverlay>
                <AlertDialogContent>
                    ...
                    <AlertDialogBody>
                        ...
                        <Input mt={2} placeholder="_uid" onChange={(e) => setUid(e.target.value)}/>
                        <Input mt={2} placeholder="__client_id" onChange={(e) => setClientID(e.target.value)}/>
                    </AlertDialogBody>
                    <AlertDialogFooter>
                        <Button ref={cancelRef} onClick={send} isLoading={loading}>保存</Button>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialogOverlay>
        </AlertDialog>
